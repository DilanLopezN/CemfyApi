...
<head>
    ...
    <title>Concessão de Uso de Gaveta Individual</title>
    <style>
        body {
...
<body>
    <h1>Concessão de Uso de Gaveta Individual por Prazo Determinado</h1>
    ...
    <div class="clause">
        ...
        <p>A concedente concede ao(à) Cessionário(a) o uso da gaveta nº <b> ${assignee.drawers.identificator}</b>, localizada no jazigo nº <b>${assignee.valts.identificator}</b>, da quadra <b>${assignee.squares.identificator} </b>, do "${graveyard.nameGraveyards}", por prazo determinado de ${assignee.dueDate} ano(s) .</p>
    </div>

    <div class="clause">
        <h2>Cláusula Segunda - Do Uso</h2>
        <p>A gaveta única objeto da presente promessa de concessão destina-se exclusivamente ao sepultamento do(a) Cessionário(a), de seus familiares, sucessores ou beneficiários, assim como ao sepultamento daqueles, cujo enterramento seja autorizado pelo Cessionário em caráter especial. A gaveta somente poderá ser reutilizada dados os 3 anos e 4 meses da data do ultimo sepultamento.
    ...
    <div class="clause">
        ...
        <p>O(a) Cessionário(a) obriga-se a pagar o preço de R$ ${assignee.saleValue}, ${assignee.payInstallments}, pago em ${assignee.payDate} </p>
